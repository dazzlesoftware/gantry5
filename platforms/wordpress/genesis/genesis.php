...
function genesis_register_private_theme_updaters(): void
{
    $private_updaters = array(
        'argon' => get_theme_root() . '/argon/private/theme-updates.php',
        'neon' => get_theme_root() . '/neon/private/theme-updates.php',
    );
...
{
    $genesis_themes = array('argon', 'neon');
...
function genesis_is_managed_theme_update(array $hook_extra): bool
{
    ...
    return in_array($hook_extra['theme'], array('argon', 'neon'), true);
}
