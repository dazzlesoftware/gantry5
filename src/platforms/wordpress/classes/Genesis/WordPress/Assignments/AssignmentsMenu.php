...
class AssignmentsMenu implements AssignmentsInterface
{
    ...
    protected function getMenus(array $args = []): array
    {
        ...
        $menus = \wp_get_nav_menus(\apply_filters('genesis_assignments_get_menus_args', $args));
    ...
    protected function getItems(object $menu): array
    {
        ...
        return \apply_filters('genesis_assignments_' . $menu->slug . '_menu_list_items', $items, $menu->slug, $this->type);
    }
