...
class AssignmentsPost implements AssignmentsInterface
{
    ...
    public function listRules(?string $configuration): array
    {
        ...
        foreach($post_types as $post_type) {
            $post_type = \apply_filters('genesis_assignments_' . $post_type->name . '_object', $post_type);
    ...
    protected function getPostTypes($args = [])
    {
        ...
        $post_types = \get_post_types(\apply_filters('genesis_assignments_get_post_types_args', $args), 'object');
    ...
    protected function getItems($post_type, $args = [])
    {
        ...
        return \apply_filters('genesis_assignments_' . $post_type->name . '_list_items', $items, $post_type, $this->type);
    ...
    protected function getTerms($taxonomies, $post_type, $args = [])
    {
        ...
        return \apply_filters('genesis_assignments_' . $post_type->name . '_terms_list_items', $items, $taxonomies, $post_type, $this->type);
    }
}
