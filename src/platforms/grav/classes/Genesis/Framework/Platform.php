...
class Platform extends BasePlatform
{
    ...
    public function getCachePath()
    {
        ...
        return $locator->findResource('cache://genesis', true, true);
    }
    ...
    public function getEnginesPaths()
    {
        ...
        if (is_link($locator('plugin://genesis/engines'))) {
            // Development environment.
            return ['' => ["plugin://genesis/engines/{$this->name}", 'plugin://genesis/engines/common']];
        }
        return ['' => ['plugin://genesis/engines']];
    }
    ...
    public function getAssetsPaths()
    {
        ...
        if (is_link($locator('plugin://genesis/assets'))) {
            // Development environment.
            return ['' => ['genesis-theme://', "plugin://genesis/assets/{$this->name}", 'plugin://genesis/assets/common']];
        }

        return ['' => ['genesis-theme://', 'plugin://genesis/assets']];
    }
    ...
    public function settings()
    {
        ...
        return $grav['base_url_relative'] . $grav['admin']->base . '/plugins/genesis';
    }
