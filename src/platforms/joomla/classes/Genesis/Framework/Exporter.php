...
use Genesis\Joomla\Contact\ContactFinder;
use Genesis\Joomla\Content\Content;
use Genesis\Joomla\Content\ContentFinder;
use Genesis\Joomla\MenuItem\MenuItemFinder;
use Genesis\Joomla\Module\ModuleFinder;
...
class Exporter
{
    ...
    public function outlines()
    {
        ...
        foreach ($list as $name => &$style) {
            ...
            $config = ConfigServiceProvider::load($genesis, $id, false, false);
...
(0,'pkg_genesis','package','pkg_genesis','',0,1,1,0,'','{}','');
...
INSERT INTO `#__extensions` (`package_id`, `name`, `type`, `element`, `folder`, `client_id`, `enabled`, `access`, `protected`, `manifest_cache`, `params`, `custom_data`) VALUES
(@package_id,'plg_system_genesis','plugin','genesis','system',0,1,1,0,'','{}',''),
(@package_id,'plg_quickicon_genesis','plugin','genesis','quickicon',0,1,1,0,'','{}',''),
(@package_id,'plg_genesis_preset','plugin','preset','genesis',0,1,1,0,'','{\"preset\":\"presets\",\"reset\":\"reset-settings\"}',''),
(@package_id,'mod_genesis_particle','module','mod_genesis_particle','',0,1,0,0,'','{\"cache\":\"1\",\"cache_time\":\"900\",\"cachemode\":\"static\"}',''),
(@package_id,'genesis_nucleus','file','genesis_nucleus','',0,1,0,0,'','{}',''),
(@package_id,'com_genesis','component','com_genesis','',1,1,0,0,'','{}',''),
(@package_id,'Genesis Framework','library','genesis','',0,1,1,0,'','{}','');
