...
namespace Genesis\Component\Content\Document;
...
/**
 * Class HtmlDocument
 * @package Genesis\Component\Content\Document
 */
class HtmlDocument
{
    use GenesisTrait;
    ...
    public static function escape($string, $strategy = 'html')
    {
        ...
        switch ($strategy) {
            ...
            case 'js':
                ...
                $callback = 'Genesis\\Component\\Content\\Document\\HtmlDocument::_escape_js_callback';
            ...
            case 'css':
                ...
                /** @var callable $callback */
                $callback = 'Genesis\\Component\\Content\\Document\\HtmlDocument::_escape_css_callback';
            ...
            case 'html_attr':
                ...
                /** @var callable $callback */
                $callback = 'Genesis\\Component\\Content\\Document\\HtmlDocument::_escape_html_attr_callback';
                $string = preg_replace_callback('#[^a-zA-Z0-9,._-]#Su', $callback, $string);
     ...
     *
     * @example {{ url('genesis-theme://images/logo.png')|default('http://www.placehold.it/150x100/f4f4f4') }}
     *
     * NOTE: In PHP this function can be called either from Genesis DI container or statically.
     *
    ...
    protected static function getObject()
    {
        ...
        if (!$object) {
            ...
            $object = Genesis::instance()['document'];
        }
