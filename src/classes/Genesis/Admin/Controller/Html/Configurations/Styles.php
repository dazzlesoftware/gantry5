...
class Styles extends HtmlController
{
    ...
    public function index()
    {
        ...
        return $this->render('@genesis-admin/pages/configurations/styles/styles.html.twig', $this->params);
    }
    ...
    public function display($id)
    {
        ...
        return $this->render('@genesis-admin/pages/configurations/styles/item.html.twig', $this->params);
    }
    ...
    public function formfield($id)
    {
        ...
        return $this->render('@genesis-admin/pages/configurations/styles/field.html.twig', $this->params);
    }
    ...
    public function compile()
    {
        ...
        if ($warnings) {
            ...
            return new JsonResponse(
                [
                    'html'    => $this->render('@genesis-admin/layouts/css-warnings.html.twig', $this->params),
                    'warning' => true,
                    'title'   => $title,
                ]
            );
