...
class Layout extends HtmlController
{
    ...
    public function particle($type, $id)
    {
        ...
        if ($particle) {
            $result = $this->render('@genesis-admin/pages/configurations/layouts/particle.html.twig', $this->params);
        } else {
            $typeLayout = $type === 'container' ? 'container' : 'section';
            $result = $this->render('@genesis-admin/pages/configurations/layouts/' . $typeLayout . '.html.twig', $this->params);
        }
    ...
    public function switchLayout($id)
    {
        ...
        $message = $deleted
            ? $this->render('@genesis-admin/ajax/particles-loss.html.twig', ['particles' => $deleted])
            : null;
