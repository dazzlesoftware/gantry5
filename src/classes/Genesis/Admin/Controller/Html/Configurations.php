...
use Genesis\Component\Response\RedirectResponse;
use Genesis\Component\Response\Response;
use Genesis\Component\Layout\Layout as LayoutObject;
use Genesis\Framework\Outlines as OutlinesObject;
...
class Configurations extends HtmlController
{
    ...
    public function createForm()
    {
        ...
        $response = ['html' => $this->render('@genesis-admin/ajax/outline-new.html.twig', $params)];
    ...
    public function create()
    {
        ...
        $html = $this->render('@genesis-admin/layouts/outline.html.twig', ['name' => $id, 'title' => $outlines[$id]]);
    ...
    public function confirmDeletion($id)
    {
        ...
        $html = $this->render('@genesis-admin/pages/configurations/confirm-deletion.html.twig', $params);
