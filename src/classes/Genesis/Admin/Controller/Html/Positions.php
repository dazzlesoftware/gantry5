...
use Genesis\Component\Position\Module;
use Genesis\Component\Position\Position;
use Genesis\Component\Response\JsonResponse;
use Genesis\Framework\Assignments;
use Genesis\Framework\Positions as PositionsObject;
...
class Positions extends HtmlController
{
    ...
    public function index()
    {
        ...
        return $this->render('@genesis-admin/pages/positions/positions.html.twig', $this->params);
    }
    ...
    public function create()
    {
        ...
        $html = $this->render('@genesis-admin/layouts/position.html.twig', ['position' => ['name' => $id, 'title' => $title]]);
    ...
    public function rename($old)
    {
        ...
        $html = $this->render('@genesis-admin/layouts/position.html.twig', ['position' => $position]);
    ...
    public function particle($position = null)
    {
        ...
        return $this->render('@genesis-admin/pages/positions/particle.html.twig', $this->params);
    }
    ...
    public function validateParticle($position, $name)
    {
        ...
        $html = $this->render('@genesis-admin/pages/positions/item.html.twig', $this->params);
