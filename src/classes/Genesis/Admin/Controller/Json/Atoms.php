...
class Atoms extends JsonController
{
    ...
    public function index()
    {
        ...
        $atoms = new \Genesis\Framework\Atoms((array) $this->container['config']->get('page.head.atoms'));
        if ($inherit) {
        ...
        $html['g-settings-atom'] = $this->render('@genesis-admin/pages/configurations/layouts/particle-card.html.twig',  $params);
        if (isset($list)) {
    ...
    public function atom()
    {
        ...
        $html = $this->render('@genesis-admin/modals/atom-preview.html.twig', $this->params);
    ...
    protected function renderAtomsInput($outline, $type, $selected, array $instances)
    {
        ...
        return $this->render('@genesis-admin/forms/fields/genesis/atoms.html.twig', $params);
    }
}
