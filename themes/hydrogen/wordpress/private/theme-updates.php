...
add_filter('pre_set_site_transient_update_themes', 'genesis_hydrogen_private_theme_updates');
 ...
 * @return string
 */
function genesis_hydrogen_private_normalize_version(string $version): string
{
 ...
 * @return object
 */
function genesis_hydrogen_private_theme_updates(mixed $transient): object
{
    ...
    $slug = 'genesis_hydrogen';
    $url = 'https://updates.genesis.org/wp-updates/genesis_hydrogen_copy.json';
    ...
    $installed_stable_version = genesis_hydrogen_private_normalize_version($installed_version);
    $available_stable_version = genesis_hydrogen_private_normalize_version($available_version);
