...
add_filter('pre_set_site_transient_update_themes', 'argon_private_theme_updates');
 ...
 * @return string
 */
function argon_private_normalize_version(string $version): string
{
 ...
 * @return object
 */
function argon_private_theme_updates(mixed $transient): object
{
    ...
    $slug = 'argon';
    $url = 'https://updates.genesis.org/wp-updates/argon_copy.json';
    ...
    $installed_stable_version = argon_private_normalize_version($installed_version);
    $available_stable_version = argon_private_normalize_version($available_version);
