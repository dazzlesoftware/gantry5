...
/**
 * Private distribution only: remote update metadata for the Argon theme.
 */

defined('ABSPATH') || die;

add_filter('pre_set_site_transient_update_themes', 'genesis_argon_private_theme_updates');
 ...
 * @return string
 */
function genesis_argon_private_normalize_version(string $version): string
{
...
/**
 * Inject update metadata for the private Argon distribution.
 *
 * @param object $transient Theme update transient.
 * @return object
 */
function genesis_argon_private_theme_updates(mixed $transient): object
{
    ...
    $slug = 'genesis_argon';
    $url = 'https://updates.genesis.org/wp-updates/genesis_argon_copy.json';
    ...
    $installed_stable_version = genesis_argon_private_normalize_version($installed_version);
    $available_stable_version = genesis_argon_private_normalize_version($available_version);
