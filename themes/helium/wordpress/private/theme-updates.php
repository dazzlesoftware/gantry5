...
add_filter('pre_set_site_transient_update_themes', 'genesis_helium_private_theme_updates');
...
function genesis_helium_private_theme_updates(mixed $transient): object
{
    ...
    $slug = 'genesis_helium';
    $url = 'https://updates.genesis.org/wp-updates/genesis_helium_copy.json';
    ...
    $installed_stable_version = genesis_helium_private_normalize_version($installed_version);
    $available_stable_version = genesis_helium_private_normalize_version($available_version);
